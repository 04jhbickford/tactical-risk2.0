// V2.81.57-unified.7 — single shell; Experimental dual-path runtime killed.
...
assert.match(html, /window\.__TR_GAME_VERSION = 'V2\.81\.57-unified\.7'/);
assert.match(html, /name="tr-game-version" content="V2\.81\.57-unified\.7"/);
