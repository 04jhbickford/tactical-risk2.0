// V2.81.57-dual-path.18 — per-row combat undo, waiting-lobby My Games.
...
assert.equal(GAME_VERSION, 'V2.81.57-dual-path.18');
assert.equal(SCHEMA_VERSION, 11);
assert.match(html, /content="V2\.81\.57-dual-path\.18"/);
assert.match(html, /__TR_GAME_VERSION = 'V2\.81\.57-dual-path\.18'/);
