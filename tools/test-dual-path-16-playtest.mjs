// V2.81.57-unified.10 — per-row combat undo, waiting-lobby My Games.
...
assert.equal(GAME_VERSION, 'V2.81.57-unified.10');
assert.equal(SCHEMA_VERSION, 11);
assert.match(html, /content="V2\.81\.57-unified\.10"/);
