...
assert.match(html, /window\.__TR_GAME_VERSION = 'V2\.81\.57-dual-path\.18'/);
assert.match(html, /name="tr-game-version" content="V2\.81\.57-dual-path\.18"/);
assert.match(html, /lockStamp/, 'HTML stamp cannot drop below .12');
assert.match(html, /src="src\/main\.js\?v=V2\.81\.57-dual-path\.18"/);
