// V2.81.57-unified.14.1 — lobby Discord name for hosts, remembered and prefilled.
...
console.log('=== V2.81.57-unified.14.1 stamp ===');
check('GAME_VERSION is V2.81.57-unified.14.1', GAME_VERSION === 'V2.81.57-unified.14.1');
check('SCHEMA_VERSION stays 11', SCHEMA_VERSION === 11);
{
  const html = readFileSync(join(root, 'index.html'), 'utf8');
  check('index.html meta stamp', html.includes('content="V2.81.57-unified.14.1"'));
  check('index.html lock stamp', html.includes("var LOCKED = 'V2.81.57-unified.14.1'"));
}
