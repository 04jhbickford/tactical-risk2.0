// V2.81.57-unified.10 — 9.23.26.01 Open Games list after Main Menu.
...
console.log('=== V2.81.57-unified.10 Open Games list (9.23.26.01) ===');
check('GAME_VERSION is V2.81.57-unified.10', GAME_VERSION === 'V2.81.57-unified.10');
check('SCHEMA_VERSION stays 11', SCHEMA_VERSION === 11);

const html = readFileSync(join(root, 'index.html'), 'utf8');
check('index.html meta stamp is unified.8', html.includes('content="V2.81.57-unified.10"'));
check('index.html lockStamp is unified.8', html.includes("var LOCKED = 'V2.81.57-unified.10'"));
check('index.html __TR_GAME_VERSION is unified.8', html.includes("window.__TR_GAME_VERSION = 'V2.81.57-unified.10'"));
check('main.js module cache-bust is unified.8', html.includes('src/main.js?v=V2.81.57-unified.10'));
