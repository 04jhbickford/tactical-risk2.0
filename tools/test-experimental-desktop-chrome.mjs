...
assert.equal(GAME_VERSION, 'V2.81.57-unified.6', 'stamp is unified.2');
...
assert.match(html, /tr-game-version" content="V2\.81\.57-unified\.6"/);
assert.match(html, /style\.css\?v=V2\.81\.57-unified\.6/);
assert.match(html, /src\/main\.js\?v=V2\.81\.57-unified\.6/);
