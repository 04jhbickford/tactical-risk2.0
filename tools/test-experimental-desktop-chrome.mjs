...
assert.match(html, /tr-game-version" content="V2\.81\.57-unified\.7"/);
assert.match(html, /style\.css\?v=V2\.81\.57-unified\.7/);
assert.match(html, /src\/main\.js\?v=V2\.81\.57-unified\.7/);
