// V2.81.57-dual-path.18 — 9.21.26.06–.11 P0 playtest cluster.
...
check('Experimental query mode is three', UX_THREE === 'three');
{
  ...
  check('index.html stamp is dual-path.18', html.includes('content="V2.81.57-dual-path.18"'));
...
console.log('\nall dual-path.18 playtest checks passed');
