// V2.81.57-unified.1 — 9.21.26.06–.11 P0 playtest cluster.
...
check('Experimental query mode is three', UX_THREE === 'three');
{
  ...
  check('index.html stamp is unified.1', html.includes('content="V2.81.57-unified.1"'));
...
console.log('\nall unified.1 playtest checks passed');
